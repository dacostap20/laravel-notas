    ...
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12 col-md-4">
                <a class="nav-link" href="{{ url('agregar-estudiante') }}">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <h5>Total Estudiantes</h5>
                                <p> {{$conteoEstudiantes}} </p>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-12 col-md-4">
                <a class="nav-link" href="{{ url('ver-cursos') }}">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <h5>Total Cursos</h5>
            ...
            <div class="col-sm-12 col-md-4">
                <a class="nav-link" href="{{ url('ver-materias') }}">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
...
<script type="text/javascript">
    var graficaMejoresEstudiantes = @json($graficaMejoresEstudiantes);
    var graficaPeoresEstudiantes = @json($graficaPeoresEstudiantes);
</script>
<script>
